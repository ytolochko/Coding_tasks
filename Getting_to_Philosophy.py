...
def bfs_traverse(start="", target_url=target_url, depth=0, max_depth=10):
    """
    Breadth-first search. I recommend to use this algorithm for searching links
    """
    queue = []
...
def dfs_traverse(start="", trace="", target_url=target_url, depth=0, max_depth=10):
    """
    Depth-first search. This is an alternative algorithm. As the name suggests, goes depth-first, which usually leads to wikipedia
